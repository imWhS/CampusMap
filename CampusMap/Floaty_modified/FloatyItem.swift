...
open class FloatyItem: UIView {
   ...
   */
  @objc open var size: CGFloat = 42 { //before 45
    didSet {
      ...
      _iconImageView?.center = CGPoint(x: size/2, y: size/2) + imageOffset
        //before       _iconImageView?.center = CGPoint(x: size/2, y: size/2 - 10) + imageOffset
  ...
  @objc open var imageSize: CGSize = CGSize(width: 25, height: 25) {
    //  before @objc open var imageSize: CGSize = CGSize(width: 45, height: 45) {
    didSet {
  ...
  @objc open var iconImageView: UIImageView {
    get {
      if _iconImageView == nil {
        ...
        _iconImageView?.layer.shadowColor = UIColor.black.cgColor
        _iconImageView?.layer.shadowOffset = CGSize(width: 0, height: 3.5)
        _iconImageView?.layer.shadowRadius = 4
        _iconImageView?.layer.shadowOpacity = 0.28
        _iconImageView?.center = CGPoint(x: size/2, y: size/2) + imageOffset
        //before _iconImageView?.center = CGPoint(x: size/2, y: size/2 - 10) + imageOffset
  ...
  fileprivate func createCircleLayer() {
    ...
    //before     circleLayer.frame = CGRect(x: castParent.itemSize/2 - (size/2), y: 0, width: 0, height: 0)
